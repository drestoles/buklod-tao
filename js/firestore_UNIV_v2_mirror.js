...
const VALIDATION_RULES = { //Rules for Validating Data
    'buklod-official': {
        'contact_number': {type: 'string', required: true, minLength: 11, maxLength: 13, regex: /^[0-9]+$/},
        ...
        'household_name': {type: 'string', required: true, maxLength: 100},
        ...
        'nearest_evac': {type: 'string', required: true, maxLength: 100},
        ...
        'status': {type: 'string'},
        'sickness_present': { type: 'string', required: true, maxLength: 100 },
